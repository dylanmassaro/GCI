...
#teal (0,0.42,0.35,1)
#salmon (0.98,0.5,0.44,1)
#dark blue (0.18,0.31,0.38,1)
...
class LoginScreen(Screen):
    def __init__(self, **kwargs):
        ...
        # username
        user_box = BoxLayout(orientation='vertical', size_hint=(1, None), height=80)
        user_box.add_widget(Label(text='Enter your username', size_hint=(1, 0.4)))
        ...
        # password
        pass_box = BoxLayout(orientation='vertical', size_hint=(1, None), height=80)
        pass_box.add_widget(Label(text='Enter your password', size_hint=(1, 0.4)))
        ...
        self.layout.add_widget(pass_box)
...
class CreateAccountPage(Screen):
    def __init__(self, **kwargs):
        ...
        self.password_input = TextInput(hint_text='Enter a password', password=True, multiline=False)
...
class SettingsPage(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.new_email_input = TextInput(hint_text='Enter new email', multiline=False)
...
class InputPage(Screen):
    def __init__(self, **kwargs):
        ...
        layout.add_widget(Label(text='Get a new risk factor', font_size=25, size_hint_y=None, height=30))
